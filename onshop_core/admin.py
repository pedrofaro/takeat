...
# Register your models here.
from onshop_core.models import Estabelecimento, Categoria, Atributo, Produto, Pergunta, Resposta, Pedido, ProdutoPedido, CompradorPedido, LocalRetiradaPedido, OpcaoPagamento, BairrosAtendidos, PushSignal
