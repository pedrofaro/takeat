...
urlpatterns = [
    ...
    url(r'^remover-blau-carrinho/$', views.excluir_item_pedido_carrinho, name='excluir_item_pedido_carrinho'), #Chamada ajax para remover pedido
	...
	url(r'^painel/vai-e-volta/$', views.vai_e_volta, name='vai_e_volta'), #Gambiarra feia para poder dar refresh na hora de imprimir pedidos novos
    ...
    url(r'^painel/imprimir-cupom/(?P<id_comanda>\d+)/(?P<id_mensagem>\d+)$', views.imprimir_cupom_mensagem, name='imprimir_cupom_mensagem'),
